...
function drawDebugPanel() {
  ...
  fill(190);
  textSize(12);
  text("D - toggle panel", panelX + 14, panelY + 46);
  text("1, 2, 3 - jump to level", panelX + 14, panelY + 66);
  text("S - start screen", panelX + 14, panelY + 86);
  text("W - win screen", panelX + 14, panelY + 106);
  text("O - game over screen", panelX + 14, panelY + 126);
